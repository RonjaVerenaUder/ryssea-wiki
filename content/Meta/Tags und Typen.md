...
| `wildnis` | Wald, Dschungel, Steppe, Wüste — unbesiedeltes Naturgebiet | Phantaura-Dschungel, Zentaurensteppe |
...
| typ | Beschreibung | Beispiele |
|---|---|---|
| `reich` | Staat, Königreich, Imperium — politische Großmacht | Baryia (Reich), Taskasia, Phantaura (Reich) |
