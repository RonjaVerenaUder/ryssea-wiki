...
status: fertig
publish: true
quelle: Vault + Notion-Export (Komponenten aus Char-Tool)
---
...
Ausführliche Informationen zum Magiesystem findest du unter [[Magieregeln]].
...
**Komponenten:** Hauptkomponente: Berührung, Hauptkomponente: Kampfkunst

---

## Akademiemagier

![[Mag_Akademiemagier.png]]
...
**Komponenten:** Formel, Geste, Hauptkomponente: Zauberbuch, Sicht
...
**Komponenten:** Hauptkomponente: Alchemie, Rezept, materielle Komponente
...
**Klassenfähigkeit:** Die Barden sind es gewohnt, das Publikum mit ihrer Kunst in ihren Bann zu ziehen. Deshalb fällt ihnen Einfluss- und Motivationszauberei besonders leicht, sodass sie einen Bonus von 1W6 auf den Grundwert dieser Zauber bekommen. Darauf begründet sich auch die Möglichkeit, eine Eigenschaft bei jedem Zauber durch Charisma zu ersetzen (dabei dürfen nicht beide Eigenschaften Charisma sein), solange sie ihn über ihre Kunst wirken.

**Komponenten:** Aufmerksamkeit, Hauptkomponente: melodische Komponente, Sicht
...
**Komponenten:** Formel, Geste, Hauptkomponente: Ritualgegenstand
...
**Komponenten:** Formel, Geste, Hauptkomponente: materielle Komponente, Sicht

---

## Elementarist [Element]

![[Mag_Elementarist.png]]
...
**Komponenten:** Formel, Hauptkomponente: Fernkampfangriff, Sicht
...
**Komponenten:** Formel, Hauptkomponente: Golem, Ritualkreis, Sicht
...
**Klassenfähigkeit:** Die magische und die profane Kunst des Heilers sind so eng verknüpft, dass jeder Heiler das Meisterhandwerk Medicus oder Seelenheiler bekommt. Zusätzlich kann der Heiler Zauber mit Hilfe seiner LeP erzwingen (1 LeP für 1 Grundwert) und um keinen seiner Patienten im Stich lassen zu müssen, ist er in der Lage, seine eigenen LeP in GLeP umzuwandeln (Verhältnis 1:1).

**Komponenten:** Formel, Geste, Hauptkomponente: Sicht

---

## Hexenmeister

![[Mag_Hexenmeister.png]]
...
**Komponenten:** Geste, Hauptkomponente: Sicht, Referenzvorlage
...
**Komponenten:** Formel, Geste, Hauptkomponente: Runensteine
...
**Komponenten:** Geste, Hauptkomponente: Berührung, Sicht

---

## Sternenmagier

![[Mag_Sternenmagier.png]]
...
**Komponenten:** Anrufung(Formel), Geste, Hauptkomponente: Totemfokus
...
**Komponenten:** Berührung, Hauptkomponente: Anatomiebuch, Sicht
...
**Komponenten:** Berührung, Formel, Geste, Hauptkomponente: Zielgegenstand
