...
> [!abstract] Kosten
> **1 Punkt** in einer Ressource kostet **7 Abenteuerpunkte (AP)**.

Bezüglich des späteren Erwerbs mit Abenteuerpunkten gilt ebenfalls die Besonderheit, dass eine Erhöhung von Ressourcen über Abenteuerpunkte immer mit der Spielleitung abgesprochen werden und zu den erlebten Abenteuern passen sollte.
...
In diesem Fall kann der Spieler (in Absprache mit der Spielleitung) Ressourcenpunkte aufsparen, um sie später im Spiel an passender Stelle einzusetzen. Möglicherweise schwebt ihm bereits eine Szene vor, in der der Held für seine Leistungen geadelt wird, oder im Spiel ergibt sich eine Situation, die ihm ein regelmäßiges Einkommen beschert. Mit Zustimmung der Spielleitung kann er dann im Laufe des Spiels Ressourcen mit den Punkten erwerben, die er sich von Spielbeginn an aufgespart hat, ohne hierfür Abenteuerpunkte aufwenden zu müssen.
